class_name Creature extends AnimatableBody2D
...
#The highest y-value the creature will navigate to
const MAXY: float = 155.0
#The lowest y-value the creature will navigate to.
const MINY: float = -60.0
